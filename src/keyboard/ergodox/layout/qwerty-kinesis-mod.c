...
// left hand
   ...
   _shiftL,     _Z,         _X,      _C,      _V,    _B, _bracketL,
     _arrowR, _arrowU, _ctrlL, _altL, _ctrlL,
                                                      _dash, _grave,
                                                0,      0, _volumeU,
                                            _bs,   _copy,  _volumeD,
// right hand
        3, _6,      _7,      _8,      _9,         _0,     _del,
   _slash, _Y,      _U,      _I,      _O,         _P, _bracketR,
           _H,      _J,      _K,      _L, _semicolon,    _enter,
_bracketR, _N,      _M,  _comma, _period,     _slash,   _shiftR,
               _ctrlR, _altR, _ctrlR,    _arrowD,     _arrowL,
_power, _equal,
_pageU,      0,      0,
